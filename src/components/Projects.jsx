...
const Projects = () => {
  return (
    <div id="Projects"
      ...
      <div className="pb-12 md:pb-0 m md:mx-[100px] mt-[50px] md:mt-[100px] flex flex-auto md:justify-center pt-3 md:pt-0  overflow-x-auto pl-3 md:pl-0  ">
      
        <div className=" h-auto px-5 py-4  text-white flex md:grid   md:grid-flow-row md:grid-cols-2  gap-14  ">
          ...
          {projectDetails.map((values, index) => {
            return (
              <div key={index}
                className="md:w-[400px] w-[335px]   h-[400px] md:h-auto shadow-[0px_0px_12px_2px_#2b6cb0] rounded-2xl 
                           bg-opacity-10 bg-transparent bg-black relative group p-10 pb-6 
                           flex flex-col justify-between overflow-hidden"           >
                <div className="">

                  <h1 className="font-PT_sans font-bold text-3xl md:text-4xl text-white ">   {values.title}      </h1>
