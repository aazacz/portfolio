...
const Education = () => {
    return (
        <div className=' border-t-8 border-t-cyan-500 w-full h-auto bg-MainBlue z-50 md:p-[80px] md:pt-[100px] ' >
            <h1 className=' font-extrabold text-[60px] font-PT_sans'> <span className=' text-transparent bg-clip-text bg-gradient-to-b from-sky-400 to-sky-200'> Education</span></h1>
